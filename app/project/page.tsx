...
const initialProjects = [
    {
        slug: 'Conov Mind',
        title: 'Convo Mind-Search Any Topic',
        image: assets.home.myLatestProject.projects.gym,
        repositoryUrl: "https://github.com/poojajuneja900/Convo-Mind.git",
        demoUrl: "https://convo-mind.vercel.app/",
        summary: 'ConvoMind is your go-to destination for finding information on any topic with ease.',
        techStacks: [
            {
                name: 'Unreal Engine',
    ...
    {
                slug: 'Tranquil Theatre',
                title: 'Tranquil Theatre-Watch Movie Together',
                image: assets.home.myLatestProject.projects.runner,
                repositoryUrl: "https://github.com/poojajuneja900/Tranquil-Theatre.git",
                demoUrl: "https://tranquil-theatre.vercel.app/",
        summary: 'This website is for watching movie together',
        techStacks: [
            {
                name: 'Unreal Engine',
                imageUrl: 'https://img.icons8.com/ios-filled/50/unreal-engine.png',
    ...
    {
        slug: 'Smart Dustbin and Segregation System',
        title: 'Smart Dustbin and Segregation System',
        image: assets.home.myLatestProject.projects.xr_3d,
        repositoryUrl: "https://postimg.cc/LY6jNWVW",
        demoUrl: "https://www.kapwing.com/w/4QQyyK79jT",
        summary: 'Developed a smart dustbin project integrating.IoT sensors for waste collection, with automated segregation of dry and wet waste.',
        techStacks: [
            {
                name: 'Figma',
    ...
    return (
        <section ref={ref} className='safe-x-padding mt-[38px] overflow-y-hidden lg:min-h-[1000px]'>
            <div className='text-center'>
                <motion.h2 initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 0.2 }} className='mb-6 text-5xl font-extrabold lg:text-6xl font-montserrat gradient-text'>Explore Pooja&apos;s Project</motion.h2>
