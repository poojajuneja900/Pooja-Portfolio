    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.linkedin.com/in/pooja-juneja-801104232/', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.instagram.com/selenophile_982/', '_blank'),
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/poojajuneja900', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            src: assets.home.letsConnect.leetcode,
            alt: "",
            width: 168,
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://leetcode.com/u/jjnsjspoooja/', '_blank')
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:jjnsjspoooja@gmail.com', "_self")
        }
            ...
            <div className='h-full mt-4'>
                <div className='relative flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-row flex-wrap items-center justify-center gap-3 mt-4 lg:hidden'>
                        ...
                        <AnimatedImage initial={{ y: -50, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0.8 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.leetcode} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('https://dribbble.com/deri-kurniawan', '_blank')} />
