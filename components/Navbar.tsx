                ...
                <div className='flex flex-row items-center justify-between py-6 border-b-2 border-b-gray safe-x-padding'>
                    <Link className='z-50' href="/" onClick={closeMenu} prefetch={false}>
                        <div className="w-[100px] h-[40px] lg:w-[100px] lg:h-[50px] ">
                            {/* <p className="h-12 w-200" > Created with ❤️</p> */}
                            {/* <img src={assets.home.hero.logo} alt="Logo" /> */}
                            {/* <img src={} /> */}
                            {/* <img src='https://i.ibb.co/vzVkdYX/logo.png' /> */}
                            {/* <img src='https://www.canva.com/design/DAGD6QqTjqc/T_scf3_A5y0m4nCt6DLMsA/view?utm_content=DAGD6QqTjqc&utm_campaign=designshare&utm_medium=link&utm_source=editor.png' /> */}
